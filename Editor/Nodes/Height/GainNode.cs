...
{
    [Serializable]
    public class GainNode : ExecutableNode<HeightGrid>
    {
        private class InputValues
        {
            ...
            {
                return HashCode.Combine(Grid?.VersionHash, Gain);
            }
        }
        ...
        private const string NODE_INPUT_GAIN_ID = "gain_input";
        private const string NODE_INPUT_GAIN_TITLE = "Gain";
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            context.AddInputPort<HeightGrid>(NODE_INPUT_GRID_ID)
                ...
                .Build();
            context.AddInputPort<float>(NODE_INPUT_GAIN_ID)
                .WithDisplayName(NODE_INPUT_GAIN_TITLE)
        ...
        private bool TryGetInputValues(out InputValues input)
        {
            ...
            var success =
                ...
                PortEvaluator.TryEvaluateInputPort(this, NODE_INPUT_GAIN_ID, out temp.Gain);
