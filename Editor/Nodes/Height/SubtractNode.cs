...
{
    [Serializable]
    [Node(categoryPath: "Modify/Height", iconPath: null, title: "Subtract")]
        ...
        : BaseNode<SubtractNode.OptionValues, SubtractNode.InputValues, HeightGrid>
    {
        ...
        protected override bool TryExecuteNodeInternal()
        {
            try
            {
                ...
                if (IsOperandConstant())
                {
                    var arithmeticOperator = ArithmeticOperator.Subtract;
                ...
                {
                    var blendOperator = BlendOperator.Subtract;
