...
{
    [Serializable]
    public class InvertNode : ExecutableNode<HeightGrid>
    {
        private class InputValues
        {
            ...
            {
                return HashCode.Combine(Grid?.VersionHash, Pivot);
            }
        }
        ...
        private const string NODE_INPUT_PIVOT_ID = "pivot_input";
        private const string NODE_INPUT_PIVOT_TITLE = "Pivot";
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            context.AddInputPort<HeightGrid>(NODE_INPUT_GRID_ID)
                ...
                .Build();
            context.AddInputPort<float>(NODE_INPUT_PIVOT_ID)
                .WithDisplayName(NODE_INPUT_PIVOT_TITLE)
                .WithDefaultValue(0f)
                .Build();
        ...
        private bool TryGetInputValues(out InputValues input)
        {
            ...
            var success =
                ...
                PortEvaluator.TryEvaluateInputPort(this, NODE_INPUT_PIVOT_ID, out temp.Pivot);
