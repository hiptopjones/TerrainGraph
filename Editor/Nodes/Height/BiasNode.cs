...
{
    [Serializable]
    public class BiasNode : ExecutableNode<HeightGrid>
    {
        private class InputValues
        {
            ...
            {
                return HashCode.Combine(Grid?.VersionHash, Bias);
            }
        }
        ...
        private const string NODE_INPUT_BIAS_ID = "bias_input";
        private const string NODE_INPUT_BIAS_TITLE = "Bias";
        ...
        // Other
        private const float DEFAULT_BIAS = 0.5f;
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            context.AddInputPort<HeightGrid>(NODE_INPUT_GRID_ID)
                ...
                .Build();
            context.AddInputPort<float>(NODE_INPUT_BIAS_ID)
                .WithDisplayName(NODE_INPUT_BIAS_TITLE)
                .WithDefaultValue(DEFAULT_BIAS)
                .Build();
        ...
        private bool TryGetInputValues(out InputValues input)
        {
            ...
            var success =
                ...
                PortEvaluator.TryEvaluateInputPort(this, NODE_INPUT_BIAS_ID, out temp.Bias);
