...
{
    [Serializable]
    public class ConstantHeightNode : ExecutableNode<HeightGrid>
    {
        private class InputValues
        {
            ...
            {
                return HashCode.Combine(Height, Size);
            }
        }
        ...
        private bool TryExecuteNodeInternal(InputValues inputValues)
        {
            try
            {
                ...
                if (!ComputeHelpers.TryLoadComputeShader("Shaders/ConstantNode", out var shader))
                {
                    return false;
                }
