...
{
    [Serializable]
    public class ContourMultiSplineNode : ExecutableNode<SplineListWrapper>
    {
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            // Output
            context.AddOutputPort<SplineListWrapper>(NODE_OUTPUT_SPLINES_ID)
                .WithDisplayName(NODE_OUTPUT_SPLINES_TITLE)
                .Build();
        }
        ...
        public override bool TryGetOutputValue(IPort _, out SplineListWrapper value)
        {
            if (!TryExecuteNode())
            {
                value = null;
        ...
        private bool TryExecuteNodeInternal(InputValues inputValues)
        {
            try
            {
                ...
                if (!ShaderWrappers.TryGenerateContours(inputGrid, contourHeight, vertexCount, size, out var outputSplines))
                {
                    return false;
                }
                ...
                outputSplineListWrapper.VersionHash = inputValues.VersionHash;
